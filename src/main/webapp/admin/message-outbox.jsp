                            ...
                            <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item active" href="${pageContext.request.contextPath}/admin/message/outbox">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/message/outbox" class="list-group-item list-group-item-action active">
                                        <i class="fas fa-paper-plane"></i> 发件箱
                                    </a>
                                ...
                                <div class="card-body p-0">
                                    <c:if test="${empty messages}">
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-muted">发件箱为空</p>
                                            <a href="${pageContext.request.contextPath}/admin/message/compose" class="btn btn-primary">
                                                <i class="fas fa-edit"></i> 发送第一条消息
                                            </a>
                                        </div>
                                    </c:if>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex justify-content-between align-items-start">
                                                                ...
                                                                ${message.subject}
                                                                    ...
                                                                    <p class="mb-1 text-muted">
                                                                        <i class="fas fa-user"></i> 发送给：${message.receiverDisplayName}
                                                                        <c:if test="${message.isRead}">
                                                                            <span class="badge bg-success ms-2">已读</span>
                                                                        </c:if>
                                                                        <c:if test="${not message.isRead}">
                                                                            <span class="badge bg-secondary ms-2">未读</span>
                                                                        </c:if>
                                                                    </p>
                                                            ...
                                                            <c:if test="${message.isRead && message.readTime != null}">
                                                                <span class="ms-2">
                                                                    ...
                                                                    <fmt:formatDate value="${message.readTime}" pattern="MM-dd HH:mm" />
                                                                </span>
                                                            </c:if>
                                                        </small>
                                                                </div>
                                                            ...
                                                            <i class="fas fa-ellipsis-v"></i>
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li>
                                                                            <a class="dropdown-item" href="${pageContext.request.contextPath}/admin/message/conversation?userId=${message.receiverId}">
